  ...
  return (
    ...
    <div style={{marginTop: "15vw", textAlign: "center"}}>
      ...
      <div className="collageImages" style={{position: "relative", top: "-3vw"}}>
        ...
        <div className='slider collageRow1Div'>
          <div className='collageImage1 collageImage5Div'>
        ...
        <div className='slider collageRow2Div'>
        ...
        <div className='collageRow3Div slider'>
        ...
        <div className="slider">
            ...
            <div className={animationStyleSliderLeft}>
                ...
                <div className='iphoneCardVectorRightDiv'>
                    <Image src={require("./images/vectorRight.svg").default} className='iphoneCardVectorLeftImage'/>
                </div>
            </div>
            <div className={animationStyleSliderLeft}>
